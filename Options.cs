...
namespace UploadAttachmentsToJira
{
    internal class Options
    {
        ...
        [Option('i', "inputpath", Required = true, HelpText = "Path where to attachments are stored. Attachment filenames should be formatted '{ISSUE-ID} - AttachmentName.Ext' where ISSUE-ID is just the number of the Jira item to use")]
